                ...
                <form action="<%= contextPath %>/tasks/create" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category" name="category" required>
                            ...
                            <option value="Work" <%= "Work".equals(task.getCategory()) ? "selected" : "" %>>Work</option>
                            <option value="Personal" <%= "Personal".equals(task.getCategory()) ? "selected" : "" %>>Personal</option>
                            <option value="Home" <%= "Home".equals(task.getCategory()) ? "selected" : "" %>>Home</option>
                            <option value="Study" <%= "Study".equals(task.getCategory()) ? "selected" : "" %>>Study</option>
                            <option value="Fitness" <%= "Fitness".equals(task.getCategory()) ? "selected" : "" %>>Fitness</option>
                            <option value="Finance" <%= "Finance".equals(task.getCategory()) ? "selected" : "" %>>Finance</option>
                            <option value="Shopping" <%= "Shopping".equals(task.getCategory()) ? "selected" : "" %>>Shopping</option>
                            <option value="Errands" <%= "Errands".equals(task.getCategory()) ? "selected" : "" %>>Errands</option>
                            <option value="Travel" <%= "Travel".equals(task.getCategory()) ? "selected" : "" %>>Travel</option>
                            <option value="Other" <%= "Other".equals(task.getCategory()) ? "selected" : "" %>>Other</option>
                        </select>
                    </div>
                    <div class="mb-3">
